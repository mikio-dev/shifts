...
from shifts.app.main import app
...
async def mock_db_shift():
    ...
    shifts = []
    shifts.append(Shift(id=1, shift_date="2022-01-01", shift_slot=1, num_workers=1))
    shifts.append(Shift(id=2, shift_date="2022-01-02", shift_slot=2, num_workers=2))
    shifts.append(Shift(id=3, shift_date="2022-01-03", shift_slot=3, num_workers=3))
    shifts.append(Shift(id=4, shift_date="2022-01-04", shift_slot=4, num_workers=4))
    shifts.append(Shift(id=5, shift_date="2022-01-05", shift_slot=5, num_workers=5))
...
async def mock_db_worker_shift():
    ...
    worker_shift = (
        ...
        Shift(id=1, shift_date="2022-01-01", shift_slot=1, num_workers=1),
        None,
    )
